            ...
            <div class="w-[493px]">
              ...
              >
                ...
                <div class="flex justify-start gap-x-4 mt-4">
                  <button class="text-sm font-bold py-3 rounded border border-base w-44 h-12 bg-white hover:filter hover:brightness-[80%]">
                  ...
                  <div>
                    <button
                      ...
                      type="button"
                      class="text-sm font-bold py-3 pl-3 rounded text-white bg-base w-40 flex items-center hover:filter hover:brightness-[80%]"
                    >
                  ...
                  <button
                    class="text-sm font-bold py-3 rounded text-white bg-base w-44 h-12 hover:filter hover:brightness-[80%]"
                    type="submit"
                  >
                    採用選考する
                  </button>
