defmodule BrightWeb.BrightCoreComponents do
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "bg-brightGray-900 border border-solid border-brightGray-900 cursor-pointer font-bold px-4 py-2 rounded select-none text-center text-white w-80 hover:filter hover:brightness-[80%]",
  ...
  def action_button(%{icon: nil} = assigns) do
    ~H"""
    <button type={@type} class={["bg-brightGray-10 text-xs lg:text-sm font-bold rounded border border-base hover:filter hover:brightness-[80%]", @class]} {@rest}>
      <%= render_slot(@inner_block) %>
    </button>
    """
  end
  ...
  def action_button(assigns) do
    ...
    <button
      type={@type}
      class={["bg-brightGray-10 text-xs lg:text-sm font-bold border border-base rounded flex items-center hover:filter hover:brightness-[80%]", @class]}
      @rest
    >
      <%= render_slot(@inner_block) %>
      <span
