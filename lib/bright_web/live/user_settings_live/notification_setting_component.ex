  ...
  def render(assigns) do
    ...
    <li class="block">
      ...
      <div class="flex mt-8 mx-auto w-fit">
        <a class="bg-brightGray-900 border border-solid border-brightGray-900 cursor-pointer font-bold px-4 py-2 rounded select-none text-center text-white w-80 hover:filter hover:brightness-[80%]">保存する</a>
      </div>
    </li>
    """
  end
