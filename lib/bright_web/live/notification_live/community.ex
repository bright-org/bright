defmodule BrightWeb.NotificationLive.Community do
  ...
  def render(assigns) do
    ~H"""
    <div
      id="notification_community_container"
      ...
      <div class="text-sm font-medium text-center">
        ...
        <%= for notification <- @notifications do %>
          <li class="flex flex-wrap my-5">
            <div
              phx-click="confirm_notification"
              phx-value-notification_community_id={notification.id}
        ...
        <TabComponents.tab_footer
          id="notification_community_footer"
          page={@page}
          total_pages={@total_pages}
          target="#notification_community_container"
        />
      </div>
    </div>
