defmodule BrightWeb.NotificationLive.Evidence do
  ...
  def render(assigns) do
    ~H"""
    <div
      id="notification_evidence_container"
      ...
      <div class="text-sm font-medium text-center">
        ...
        <%= for notification <- @notifications do %>
          <li class="flex flex-wrap my-5">
            <div
              phx-click="click"
              phx-value-notification_evidence_id={notification.id}
        ...
        <TabComponents.tab_footer
          id="notification_evidence_footer"
          page={@page}
          total_pages={@total_pages}
          target="#notification_evidence_container"
        />
      </div>
    </div>
