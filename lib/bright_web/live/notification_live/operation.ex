defmodule BrightWeb.NotificationLive.Operation do
  ...
  def render(assigns) do
    ~H"""
    <div
      id="notification_operation_container"
    ...
    >
      <div class="text-sm font-medium text-center">
        ...
        <%= for notification <- @notifications do %>
          <li class="flex flex-wrap my-5">
            <div
              ...
              phx-value-notification_operation_id={notification.id}
        ...
        <TabComponents.tab_footer
          id="notification_operation_footer"
          page={@page}
          total_pages={@total_pages}
          target="#notification_operation_container"
        />
      </div>
    </div>
