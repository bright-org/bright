defmodule BrightWeb.SkillPanelLive.SkillShareModalComponent do
  ...
  def render(assigns) do
    assigns =
      assigns
      |> assign(url: url(~p"/get_skill_panel/#{assigns.skill_panel.id}?ogp=#{assigns.ogp}"))
    ...
    <div id={@id}>
      ...
      >
        ...
        <SnsComponents.sns_share_button_group share_graph_url={@url} skill_panel={@skill_panel.name} level_text={"start"} phx_click="skill_sns_up_click" />
