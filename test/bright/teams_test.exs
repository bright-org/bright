defmodule Bright.TeamsTest do
  ...
  describe "team_default_skill_panels" do
    ...
    test "list_team_default_skill_panels/0 returns all team_default_skill_panels" do
      team_default_skill_panel = team_default_skill_panel_fixture()
      assert Teams.list_team_default_skill_panels() == [team_default_skill_panel]
    end

    test "get_team_default_skill_panel!/1 returns the team_default_skill_panel with given id" do
      team_default_skill_panel = team_default_skill_panel_fixture()
      assert Teams.get_team_default_skill_panel!(team_default_skill_panel.id) == team_default_skill_panel
    end

    test "create_team_default_skill_panel/1 with valid data creates a team_default_skill_panel" do
      valid_attrs = %{team_id: "7488a646-e31f-11e4-aace-600308960662", skill_panel_id: "7488a646-e31f-11e4-aace-600308960662"}

      assert {:ok, %TeamDefaultSkillPanel{} = team_default_skill_panel} = Teams.create_team_default_skill_panel(valid_attrs)
      assert team_default_skill_panel.team_id == "7488a646-e31f-11e4-aace-600308960662"
      assert team_default_skill_panel.skill_panel_id == "7488a646-e31f-11e4-aace-600308960662"
    end

    test "create_team_default_skill_panel/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = Teams.create_team_default_skill_panel(@invalid_attrs)
    end

    test "update_team_default_skill_panel/2 with valid data updates the team_default_skill_panel" do
      team_default_skill_panel = team_default_skill_panel_fixture()
      update_attrs = %{team_id: "7488a646-e31f-11e4-aace-600308960668", skill_panel_id: "7488a646-e31f-11e4-aace-600308960668"}

      assert {:ok, %TeamDefaultSkillPanel{} = team_default_skill_panel} = Teams.update_team_default_skill_panel(team_default_skill_panel, update_attrs)
      assert team_default_skill_panel.team_id == "7488a646-e31f-11e4-aace-600308960668"
      assert team_default_skill_panel.skill_panel_id == "7488a646-e31f-11e4-aace-600308960668"
    end

    test "update_team_default_skill_panel/2 with invalid data returns error changeset" do
      team_default_skill_panel = team_default_skill_panel_fixture()
      assert {:error, %Ecto.Changeset{}} = Teams.update_team_default_skill_panel(team_default_skill_panel, @invalid_attrs)
      assert team_default_skill_panel == Teams.get_team_default_skill_panel!(team_default_skill_panel.id)
    end

    test "delete_team_default_skill_panel/1 deletes the team_default_skill_panel" do
      team_default_skill_panel = team_default_skill_panel_fixture()
      assert {:ok, %TeamDefaultSkillPanel{}} = Teams.delete_team_default_skill_panel(team_default_skill_panel)
      assert_raise Ecto.NoResultsError, fn -> Teams.get_team_default_skill_panel!(team_default_skill_panel.id) end
    end

    test "change_team_default_skill_panel/1 returns a team_default_skill_panel changeset" do
      team_default_skill_panel = team_default_skill_panel_fixture()
      assert %Ecto.Changeset{} = Teams.change_team_default_skill_panel(team_default_skill_panel)
    end
  end
end
