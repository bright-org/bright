defmodule Bright.RecruitmentStockUsers do
  ...
  Raises `Ecto.NoResultsError` if the Recruitment stock user does not exist.
  ...
  """
  def change_recruitment_stock_user(%RecruitmentStockUser{} = recruitment_stock_user, attrs \\ %{}) do
