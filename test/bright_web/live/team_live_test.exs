defmodule BrightWeb.TeamLiveTest do
  use BrightWeb.ConnCase

  import Phoenix.LiveViewTest
  import Bright.TeamsFixtures

  @create_attrs %{team_name: "some team_name", enable_hr_functions: true, auther_bright_user_id: 42}
  @update_attrs %{team_name: "some updated team_name", enable_hr_functions: false, auther_bright_user_id: 43}
  @invalid_attrs %{team_name: nil, enable_hr_functions: false, auther_bright_user_id: nil}
