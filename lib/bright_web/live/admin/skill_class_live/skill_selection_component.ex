defmodule BrightWeb.Admin.SkillClassLive.SkillSelectionComponent do
  @moduledoc """
  スキル階層
  ...
  def handle_event("select_skill_panel", params, socket) do
    ...
    skill_panel = SkillPanels.get_skill_panel(skill_panel_id)
  ...
  def handle_event("select_skill_class", params, socket) do
    ...
    skill_class = SkillPanels.get_skill_class!(skill_class_id)
  ...
  def handle_event("select_skill_unit", params, socket) do
    ...
    skill_unit = SkillUnits.get_skill_unit(skill_unit_id)
  ...
  def handle_event("select_skill_category", params, socket) do
    ...
    skill_category = SkillUnits.get_skill_category(skill_category_id)
  ...
  defp assign_skill_class_options(socket) do
    ...
    options =
      Ecto.assoc(skill_panel, :skill_classes)
  ...
  defp assign_skill_category_options(socket) do
    ...
    options =
      SkillUnits.list_skill_categorys_on_unit(skill_unit)
      |> Enum.map(&{&1.name, &1.id})
