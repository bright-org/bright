    ...
    <li class="block">
      <.form id="general_setting_form" :let={f} for={@form} phx-target={@myself} phx-submit="save" phx-change="validate">
        ...
        <div class="flex mt-8 relative">
          <button type="submit" class="bg-brightGray-900 border block border-solid border-brightGray-900 cursor-pointer font-bold mx-auto px-4 py-2 rounded select-none text-center text-white w-80 hover:filter hover:brightness-[80%]">保存する</button>
        </div>
      </.form>
    </li>
    """
